...
class WikipediaLayer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'WikipediaLayer_{}.qm'.format(locale))
        ...
        self.dlg = WikipediaLayerDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&Wikipedia Layer')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'WikipediaLayer')
        self.toolbar.setObjectName(u'WikipediaLayer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WikipediaLayer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/WikipediaLayer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Add Wikipedia Layer'),
            callback=self.run,
